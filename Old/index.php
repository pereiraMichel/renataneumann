            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        <li <?php echo $home; ?> style="width: 100px; text-align: center;"><a href="index.php">Home</a></li>
                        <li <?php echo $servicos; ?> style="width: 100px; text-align: center;"><a href="index.php?m=servicos">Serviços</a></li>
                        <li <?php echo $contato; ?> style="width: 100px; text-align: center;"><a href="index.php?m=contato">Contato</a></li>
...
//                                echo "</section>";
        ...
        <script src="https://use.fontawesome.com/320c8feecd.js"></script>
        <script>
